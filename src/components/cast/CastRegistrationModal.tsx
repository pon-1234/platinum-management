...
export function CastRegistrationModal({
  ...
  const loadAvailableStaff = async () => {
    ...
    try {
      ...
      // Get existing casts to filter out already registered staff
      const existingCasts = await castService.getAllCasts();
      ...
      >
        ...
        <div>
          ...
          {form.formState.errors.stageName && (
            <ErrorMessage message={form.formState.errors.stageName.message!} />
          )}
        </div>
        ...
        <div>
          ...
          {form.formState.errors.hourlyRate && (
            <ErrorMessage message={form.formState.errors.hourlyRate.message!} />
          )}
        </div>
